...
class MalayStrings {
  static final Map<String, String> strings = {
    ...
    // Budget plan charts
    'budget_plans.chart_deposits': 'Deposit',
    'budget_plans.chart_spendings': 'Perbelanjaan',
    'budget_plans.chart_milestones': 'Milestone',
    'budget_plans.week_1': 'Minggu 1',
    'budget_plans.week_2': 'Minggu 2',
    ...
    'budget_plans.due_today': 'Berakhir hari ini',
    'budget_plans.due_tomorrow': 'Berakhir esok',
    'budget_plans.due_in_days': 'Berakhir dalam %d hari',
    'budget_plans.days_overdue': '%d hari terlambat',
    'budget_plans.status_unpaid': 'Belum Dibayar',
    'budget_plans.status_paid': 'Dibayar',
    'budget_plans.status_partial': 'Sebahagian',
    'budget_plans.total_paid_label': 'Jumlah Dibayar',
    'budget_plans.allocation_by_category': 'Peruntukan Mengikut Kategori',
    'budget_plans.spending_trend': 'Trend Perbelanjaan',
    // Budget options
    'budgets.deactivate': 'Nyahaktif',
    'budgets.activate': 'Aktif',
    'budgets.delete': 'Padam Belanjawan',
    'budgets.delete_msg': 'Padam {name}? Tindakan ini tidak boleh dibuat alik.',
    'budgets.error_loading': 'Gagal memuatkan belanjawan',
    'budgets.filter': 'Tapis Belanjawan',
    'budgets.edit_budget': 'Sunting Belanjawan',
    'budgets.update_success': 'Belanjawan berjaya dikemaskini',
    // Create budget
    'budgets.name': 'Nama Belanjawan',
    'budgets.name_hint': 'cth., Barang Runcit',
    'budgets.limit_amount': 'Had Belanjawan',
    'budgets.period': 'Tempoh',
    'budgets.category': 'Kategori',
    'budgets.select_category': 'Pilih kategori',
    'budgets.created': 'Belanjawan berjaya dicipta',
    'budgets.error.valid_amount': 'Sila masukkan jumlah yang sah',
    'budgets.error.select_category': 'Sila pilih kategori',
    ...
    "budget_plans.has_deposit_sub": "Rekod wang masuk ke dalam pelan",
    ...
    'transaction.update': 'Kemaskini Transaksi',
    'transaction.updating': 'Mengemaskini...',
    'transaction.created_success': 'Transaksi berjaya ditambah',
    'transaction.updated_success': 'Transaksi berjaya dikemaskini',
    'transaction.unknown': 'Tidak diketahui',
    'transaction.add.description': 'Keterangan',
    ...
    'transaction.field.type': 'Jenis Transaksi',
    'transaction.field.amount': 'Jumlah',
    'transaction.account.select': 'Pilih Akaun',
    'transaction.category.select_hint': 'Pilih kategori',
    'transaction.category.search_hint': 'Cari kategori',
    'transaction.category.no_results': 'Tiada hasil untuk "{query}"',
    'transaction.field.transfer_accounts': 'Akaun Pindahan',
    'transaction.field.received_into': 'Diterima Ke Akaun',
    ...
    'transaction.edit.locked_fields_info':
        'Jenis, jumlah, dan akaun tidak boleh diubah selepas transaksi disimpan.',
    'transaction.account.unnamed': 'Tanpa Nama',
    'transaction.account.unknown': 'Akaun Tidak Diketahui',
    'transaction.account.no_accounts':
        'Tiada akaun simpanan. Sila tambah satu dahulu.',
    'transaction.account.received_into': 'Diterima Ke Akaun',
    'transaction.account.paid_from': 'Dibayar Dari Akaun',
    'transaction.account.received_hint': 'Pilih akaun untuk menerima wang',
    'transaction.account.paid_hint': 'Pilih akaun yang digunakan untuk bayaran',
    'transaction.transfer.between_accounts': 'Pindahan Antara Akaun',
    'transaction.transfer.from': 'Dari Akaun',
    'transaction.transfer.from_hint': 'Pilih akaun sumber',
    'transaction.transfer.to': 'Ke Akaun',
    'transaction.transfer.to_hint': 'Pilih akaun destinasi',
    'transaction.category.uncategorized': 'Tiada Kategori',
    'transaction.category.empty_hint': 'Tiada kategori. Tambah dalam Tetapan.',
    'transaction.payee.select_hint': 'Pilih penerima',
    'transaction.payee.no_payees': 'Tiada penerima lagi — tambah dalam Tetapan',
    'transaction.payee.none_recorded': 'Tiada penerima direkod',
    'transaction.error.description_required': 'Sila masukkan keterangan',
    'transaction.error.amount_required':
        'Sila masukkan jumlah yang sah melebihi 0',
    'transaction.error.account_required': 'Sila pilih akaun',
    'transaction.error.source_account_required': 'Sila pilih akaun sumber',
    'transaction.error.destination_account_required':
        'Sila pilih akaun destinasi',
    'transaction.error.category_required': 'Sila pilih kategori',
    'transaction.history.empty_title': 'Belum ada transaksi',
    'transaction.history.empty_subtitle':
        'Mula jejak wang anda dengan menambah transaksi pertama.',
    'transaction.history.no_results': 'Tiada padanan ditemui',
    'transaction.history.no_results_hint':
        'Cuba kata kunci lain atau kosongkan penapis.',
    'transaction.filter.all_types': 'Semua Jenis',
    'general.optional': 'pilihan',
  };
}
