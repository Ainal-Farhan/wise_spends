...
class MalayStrings {
  static final Map<String, String> strings = {
    ...
    'general.invalid_number': 'Nombor tidak sah',
    'general.must_be_positive': 'Mesti lebih daripada 0',
    'general.note_optional': 'Nota (pilihan)',
    ...
    'transaction.type.loan_disbursement': 'Pengeluaran Pinjaman',
    'transaction.type.loan_repayment': 'Bayaran Balik Pinjaman',
    'transaction.type.lending_disbursement': 'Wang Dipinjamkan',
    'transaction.type.lending_repayment': 'Penerimaan Bayaran Pinjaman',
    ...
    'home.loans_outstanding': 'Pinjaman Perlu Dibayar',
    'home.loans_active': 'Aktif',
    'home.loans_total_outstanding': 'Jumlah Perlu Dibayar',
    'home.loans_repaid_month': 'Dibayar Bulan Ini',
    'home.loans_nearest_due': '{name} perlu dibayar {date}',
    ...
    'budget_plans.total_spent': 'Jumlah dibelanjakan',
    'budget_plans.items_overview': 'Ringkasan item',
    'budget_plans.item_paid': 'Telah dibayar',
    'budget_plans.item_paid_exclude_deposit': 'Telah dibayar (Kecuali Deposit)',
    'budget_plans.partial': 'Separa bayar',
    'budget_plans.all_items_paid': 'Semua item dijelaskan',
    'budget_plans.item_cost': 'Kos item',
    'budget_plans.item_progress': 'Kemajuan bayaran',
    'budget_plans.total_paid': 'Jumlah dibayar',
    'budget_plans.deposit_only': 'Deposit sahaja',
    'budget_plans.fully_paid': 'Telah dijelaskan',
    ...
    'savings.credit_card_charges': 'Caj Kad Kredit',
    ...
    'categories.category_name': 'Nama Kategori',
    'categories.name_hint': 'cth., Makanan, Pengangkutan, Membeli-belah',
    'categories.name_too_short': 'Nama mestilah sekurang-kurangnya 2 aksara',
    'categories.tap_to_change_icon': 'Ketik untuk tukar ikon',
    'categories.total': 'Jumlah',
    'categories.no_results': 'Tiada kategori ditemui',
    'categories.no_results_desc': 'Cuba laraskan carian atau penapis anda',

    // Icons
    'icons.all': 'Semua',
    'icons.food': 'Makanan',
    'icons.transport': 'Pengangkutan',
    'icons.shopping': 'Membeli-belah',
    'icons.entertainment': 'Hiburan',
    'icons.bills': 'Bil',
    'icons.health': 'Kesihatan',
    'icons.education': 'Pendidikan',
    'icons.income': 'Pendapatan',
    'icons.technology': 'Teknologi',
    'icons.home': 'Rumah',
    'icons.sports': 'Sukan',
    'icons.travel': 'Perjalanan',
    'icons.other': 'Lain-lain',
    'icons.search': 'Cari ikon...',
    'icons.preview': 'Pratonton dengan nama',
    'icons.no_results': 'Tiada ikon ditemui',
    'icons.no_results_desc': 'Cuba istilah carian atau kategori berbeza',
    ...
    // ── Kad Kredit ───────────────────────────────────────────────────────────
    'credit_card.title': 'Kad & Bayar Kemudian',
    'credit_card.empty': 'Tiada kad lagi. Ketik + untuk tambah.',
    'credit_card.add': 'Tambah Kad',
    ...
    'credit_card.label_due_day': 'Hari bayar: {day} setiap bulan',
    'credit_card.label_statement': 'Penyata: hari {day}',
    'credit_card.label_due': 'Bayar: hari {day}',
    'credit_card.statement_due': 'Penyata: hari {stmt}  •  Bayar: hari {due}',
    'credit_card.field_name': 'Nama Kad',
    'credit_card.field_last4': '4 Digit Terakhir (pilihan)',
    'credit_card.field_limit': 'Had Kredit',
    'credit_card.field_statement_day': 'Hari Penyata',
    'credit_card.field_due_day': 'Hari Bayar',
    'credit_card.btn_add': 'Tambah Kad',
    'credit_card.tab_charges': 'Caj',
    'credit_card.tab_payments': 'Bayaran',
    'credit_card.charges_empty': 'Tiada caj lagi.',
    'credit_card.payments_empty': 'Tiada bayaran lagi.',
    'credit_card.add_charge': 'Tambah Caj',
    'credit_card.make_payment': 'Buat Bayaran',
    'credit_card.charge_description': 'Penerangan',
    'credit_card.charge_amount': 'Jumlah',
    'credit_card.charge_date': 'Tarikh: {date}',
    'credit_card.charge_btn': 'Tambah Caj',
    'credit_card.payment_amount': 'Jumlah',
    'credit_card.payment_source': 'Akaun Simpanan Sumber',
    'credit_card.payment_date': 'Tarikh: {date}',
    'credit_card.payment_allocate': 'Peruntukkan kepada caj tertentu',
    'credit_card.payment_btn': 'Buat Bayaran',
    'credit_card.charge_date_prefix': 'Tarikh',
    ...
    'credit_card.free_charges_title': 'Caj (sumber manual)',
    'credit_card.auto_deduct': 'Tolak auto',
    ...
    'credit_card.payment_breakdown': 'Caj Diliputi',
    ...
    'credit_card.add_rebate': 'Tambah Rebat',
    'credit_card.rebate_description': 'Penerangan rebat',
    'credit_card.rebate_btn': 'Tambah Rebat',
    'credit_card.rebate_credits_title': 'Kredit Tersedia',
    'credit_card.rebate_credits_applied': 'Kredit Digunakan',
    'credit_card.payment_net': 'Jumlah Bersih',
    'credit_card.pending_toggle': 'Tandakan sebagai Tertangguh',
    'credit_card.pending_hint': 'Caj ini belum disahkan oleh bank.',
    'credit_card.status_pending': 'Tertangguh',
    'credit_card.status_rebate': 'Rebat',
    'credit_card.filter_all': 'Semua',
    'credit_card.filter_unpaid': 'Belum Bayar',
    'credit_card.filter_pending': 'Tertangguh',
    'credit_card.filter_paid': 'Sudah Bayar',
    ...
    'home.credit_cards_title': 'Kad & Bayar Kemudian',
    'home.credit_cards_count': 'Kad',
    'home.credit_cards_total_debt': 'Jumlah Hutang',
    'home.credit_cards_reserved': 'Dirizab',
    'home.financial_overview': 'Kesihatan Simpanan',
    'home.available': 'Tersedia',
    'home.reserved': 'Dirizab',
    'home.total_saved': 'Jumlah Simpanan',
    'home.spending_7d': 'Perbelanjaan 7 Hari',
    ...
    'loan.label_outstanding': 'Perlu Dibayar',
    'loan.label_loaned': 'Diterima: {date}',
    'loan.label_due': 'Tempoh: {date}',
    'loan.label_note': 'Nota: {note}',
    'loan.status_active': 'Aktif',
    'loan.status_settled': 'Selesai',
    'loan.field_borrower': 'Nama Pemberi Pinjam',
    'loan.field_amount': 'Jumlah Prinsipal',
    'loan.field_source': 'Masuk ke Akaun',
    'loan.field_loan_date': 'Tarikh Pinjaman: {date}',
    'loan.field_due_date': 'Tarikh Tamat: {date}',
    'loan.field_due_date_empty': 'Tarikh Tamat: Tidak ditetapkan',
    'loan.btn_add': 'Tambah Pinjaman',
    'loan.btn_settle': 'Tandakan Selesai',
    'loan.repayments_title': 'Bayaran Balik',
    'loan.repayments_empty': 'Tiada bayaran balik lagi.',
    'loan.record_repayment': 'Rekod Bayaran Balik',
    'loan.repayment_amount': 'Jumlah',
    'loan.repayment_destination': 'Bayar Dari Akaun',
    'loan.repayment_date': 'Tarikh: {date}',
    'loan.repayment_btn': 'Rekod Bayaran Balik',
    'loan.repayment_date_prefix': 'Tarikh',
    'loan.filter_all': 'Semua',
    'loan.filter_active': 'Aktif',
    'loan.filter_settled': 'Selesai',
    'loan.search_hint': 'Cari pemberi pinjam…',
    'loan.search_empty': 'Tiada pinjaman sepadan.',
    'loan.repayments_count': '{count} pembayaran balik',
    'loan.label_fully_repaid': 'Telah Dibayar Penuh',
    'loan.due_overdue': 'Tertunggak {days} hari',
    'loan.due_soon': 'Tamat dalam {days} hari',
    'loan.due_in': 'Tamat {date}',
    'loan.banner_overdue': 'Pinjaman ini tertunggak {days} hari',
    'loan.banner_due_soon': 'Tamat dalam {days} hari — ikuti segera',
    'loan.banner_due_upcoming': 'Tamat pada {date}',
    'loan.settle_title': 'Tandakan Selesai',
    'loan.settle_confirm': 'Tandakan pinjaman "{name}" sebagai selesai?',
    'loan.outstanding_hint': 'Baki tertunggak: {amount}',
    'loan.full_amount': 'Penuh',
    'loan.field_loan_date_prefix': 'Tarikh Pinjaman',
    'loan.field_due_date_prefix': 'Tarikh Tamat',
    'loan.no_auto_deduct': 'Terima Luar Apl (Tiada Kredit)',
    'loan.no_auto_deduct_hint':
        'Pinjaman diterima luar apl — tiada akaun simpanan dikreditkan.',
    'loan.edit': 'Kemaskini Pinjaman',
    'loan.edit_note':
        'Kemaskini tidak mengira semula baki simpanan. Hanya maklumat asas dikemaskini.',
  };
}
