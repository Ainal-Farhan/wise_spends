...
class EnglishStrings {
  static final Map<String, String> strings = {
    ...
    'general.invalid_number': 'Invalid number',
    'general.must_be_positive': 'Must be greater than 0',
    'general.note_optional': 'Note (optional)',
    'general.retry': 'Retry',
    ...
    'home.loans_outstanding': 'Loans to Repay',
    'home.loans_active': 'Active',
    'home.loans_total_outstanding': 'Total to Repay',
    'home.loans_repaid_month': 'Repaid This Month',
    'home.loans_nearest_due': '{name} due {date}',
    ...
    'budget_plans.deposit_source.account': 'Into Account',
    ...
    'budget_plans.total_spent': 'Total spent',
    'budget_plans.items_overview': 'Items overview',
    'budget_plans.item_paid': 'Total paid',
    'budget_plans.item_paid_exclude_deposit': 'Total paid (Exclude Deposit)',
    'budget_plans.partial': 'Partially paid',
    'budget_plans.all_items_paid': 'All items settled',
    'budget_plans.item_cost': 'Item Cost',
    'budget_plans.item_progress': 'Payment progress',
    'budget_plans.deposit_only': 'Deposit only',
    'budget_plans.available': 'Available',
    'budget_plans.collected': 'Collected',
    'budget_plans.spending_source': 'Spending source',
    'budget_plans.cap_exceeded': 'Amount exceeds available balance',
    'budget_plans.available_to_spend': 'Available to spend',
    'budget_plans.cap_is': 'Cap is {amount}',
    ...
    'savings.credit_card_charges': 'Credit Card Charges',
    ...
    'categories.name_hint': 'e.g., Food, Transport, Shopping',
    'categories.name_too_short': 'Name must be at least 2 characters',
    'categories.tap_to_change_icon': 'Tap to change icon',
    'categories.total': 'Total',
    'categories.no_results': 'No categories found',
    'categories.no_results_desc': 'Try adjusting your search or filters',
    ...
    'icons.entertainment': 'Entertainment',
    'icons.bills': 'Bills',
    'icons.health': 'Health',
    ...
    'icons.preview': 'Preview with name',
    'icons.no_results': 'No icons found',
    'icons.no_results_desc': 'Try a different search term or category',
    ...
    // ── Credit Card ──────────────────────────────────────────────────────────
    'credit_card.title': 'Cards & Pay Later',
    'credit_card.empty': 'No cards yet. Tap + to add one.',
    'credit_card.add': 'Add Card',
    'credit_card.delete_title': 'Delete Card',
    'credit_card.delete_confirm': 'Delete "{name}"? This cannot be undone.',
    'credit_card.label_limit': 'Limit',
    'credit_card.label_debt': 'Debt',
    'credit_card.label_available': 'Available',
    'credit_card.label_due_day': 'Due day: {day} of month',
    'credit_card.label_statement': 'Statement: day {day}',
    'credit_card.label_due': 'Due: day {day}',
    'credit_card.statement_due': 'Statement: day {stmt}  •  Due: day {due}',
    'credit_card.field_name': 'Card Name',
    'credit_card.field_last4': 'Last 4 Digits (optional)',
    'credit_card.field_limit': 'Credit Limit',
    'credit_card.field_statement_day': 'Statement Day',
    'credit_card.field_due_day': 'Due Day',
    'credit_card.btn_add': 'Add Card',
    'credit_card.tab_charges': 'Charges',
    'credit_card.tab_payments': 'Payments',
    'credit_card.charges_empty': 'No charges yet.',
    'credit_card.payments_empty': 'No payments yet.',
    'credit_card.add_charge': 'Add Charge',
    'credit_card.make_payment': 'Make Payment',
    'credit_card.charge_description': 'Description',
    'credit_card.charge_amount': 'Amount',
    'credit_card.charge_date': 'Date: {date}',
    'credit_card.charge_btn': 'Add Charge',
    'credit_card.payment_amount': 'Amount',
    'credit_card.payment_source': 'Source Saving Account',
    'credit_card.payment_date': 'Date: {date}',
    'credit_card.payment_allocate': 'Allocate to specific charges',
    'credit_card.payment_btn': 'Make Payment',
    'credit_card.charge_date_prefix': 'Date',
    ...
    'credit_card.free_charges_title': 'Charges (manual source)',
    'credit_card.auto_deduct': 'Auto-deduct',
    ...
    'credit_card.payment_breakdown': 'Charges Covered',
    ...
    'home.credit_cards_title': 'Cards & Pay Later',
    ...
    // ── Loan ─────────────────────────────────────────────────────────────────
    'loan.title': 'Loans',
    'loan.empty': 'No loans yet. Tap + to record a loan.',
    'loan.add': 'Add Loan',
    'loan.delete_title': 'Delete Loan',
    'loan.delete_confirm': 'Delete loan for "{name}"? This cannot be undone.',
    'loan.label_principal': 'Principal',
    'loan.label_outstanding': 'To Repay',
    'loan.label_loaned': 'Received: {date}',
    'loan.label_due': 'Due: {date}',
    'loan.label_note': 'Note: {note}',
    'loan.status_active': 'Active',
    'loan.status_settled': 'Settled',
    'loan.field_borrower': 'Lender Name',
    'loan.field_amount': 'Principal Amount',
    'loan.field_source': 'Deposit to Account',
    'loan.field_loan_date': 'Loan Date: {date}',
    'loan.field_due_date': 'Due Date: {date}',
    'loan.field_due_date_empty': 'Due Date: Not set',
    'loan.btn_add': 'Add Loan',
    'loan.btn_settle': 'Mark as Settled',
    'loan.repayments_title': 'Repayments',
    'loan.repayments_empty': 'No repayments yet.',
    'loan.record_repayment': 'Record Repayment',
    'loan.repayment_amount': 'Amount',
    'loan.repayment_destination': 'Pay from Account',
    'loan.repayment_date': 'Date: {date}',
    'loan.repayment_btn': 'Record Repayment',
    'loan.repayment_date_prefix': 'Date',
    'loan.filter_all': 'All',
    'loan.filter_active': 'Active',
    'loan.filter_settled': 'Settled',
    'loan.search_hint': 'Search lender…',
    'loan.search_empty': 'No loans match your search.',
    'loan.repayments_count': '{count} repayments',
    'loan.label_fully_repaid': 'Fully Repaid',
    'loan.due_overdue': 'Overdue by {days} days',
    'loan.due_soon': 'Due in {days} days',
    'loan.due_in': 'Due {date}',
    'loan.banner_overdue': 'This loan is overdue by {days} days',
    'loan.banner_due_soon': 'Due in {days} days — follow up soon',
    'loan.banner_due_upcoming': 'Due on {date}',
    'loan.settle_title': 'Mark as Settled',
    'loan.settle_confirm': 'Mark loan for "{name}" as fully settled?',
    'loan.outstanding_hint': 'Outstanding balance: {amount}',
    'loan.full_amount': 'Full',
    'loan.field_loan_date_prefix': 'Loan Date',
    'loan.field_due_date_prefix': 'Due Date',
    'loan.no_auto_deduct': 'External Deposit (No Account)',
    'loan.no_auto_deduct_hint':
        'Loan received outside the app — no saving account credited.',
    'loan.edit': 'Edit Loan',
    'loan.edit_note':
